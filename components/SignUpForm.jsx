    ...
    return (
        <>
            <section className=" flex-col justify-items-center items-center  ">
                <form className="mt-10  flex flex-col gap-4 glassmorphism">
                    <label className="block font-medium text-gray-900 text-xl">Nombre Completo</label>
                    <div className="flex ">
                    ...
                    <label className="block  font-medium text-gray-900 text-xl">Número de Celular</label>
                    <div className="flex">
                        <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md">
                        ...
                        <input type="phone" id="phone" className=" rounded-none rounded-r-lg border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " />
                    </div>
                    <label className="block font-medium text-gray-900 text-xl">Dirección</label>
                    <div className="flex">
                        <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"className="w-4 h-4 text-gray-500 dark:text-gray-400">
